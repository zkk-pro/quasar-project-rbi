export default {
  ...
  com_enter_password_again: '请再次输入登录密码',
  ...
  register_password: '登入密码6-20位，由字母和数字组成',
  register_has_user: '已有账号，去登录',
  register_agree: '我已阅读并同意',
  register_agreement: '《用户协议》',
  register_agreement_reqiured: '请阅读并同意下方用户协议',
  register_email_no: '邮箱不符合规范',

  p_index1: 'p_index1_zh',
  p_index2: 'p_index2_zh',
  p_index3: 'p_index3_zh',
  p_index4: 'p_index4_zh',
